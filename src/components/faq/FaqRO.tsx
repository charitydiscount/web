...
class FaqRO extends React.Component {
    render() {
        return (
            <React.Fragment>
                <p className="sample-text">
                    <ol>
                        <li className="p-2">Cum funcționează</li>
                        <ul>
                            ...
                            <li>
                                Revi pe CharityDiscount pentru a verifica câți
                                bani ai economisit (durează câteva minute)
                            </li>
                        </ul>
                    </ol>
                </p>
